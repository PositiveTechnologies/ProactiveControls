...
- [About OWASP](#about-owasp)
- [FOREWORD](#foreword)
    - [AIM & OBJECTIF](#aim--objectif)
...
- [DOCUMENT STRUCTURE](#document-structure)
    ...
    - [Vulnerabilities Prevented](#vulnerabilities-prevented)
    - [References](#references)
    - [Tools](#tools)
- [INTRODUCTION](#introduction)
    - [The Top 10 Proactive Controls](#the-top-10-proactive-controls)
    - [How this List Was Created](#how-this-list-was-created)
    - [Target Audience](#target-audience)
    - [How to Use this Document](#how-to-use-this-document)
    - [Link to the OWASP Top 10 Project](#link-to-the-owasp-top-10-project)
- [C1: Define Security Requirements](#c1-define-security-requirements)
    - [Description](#description-1)
        - [The OWASP ASVS](#the-owasp-asvs)
        - [Augmenting Requirements with User Stories and Misuse Cases](#augmenting-requirements-with-user-stories-and-misuse-cases)
    - [Implementation](#implementation-1)
        - [Discovery and Selection](#discovery-and-selection)
        - [Investigation and Documentation](#investigation-and-documentation)
        - [Implementation and Test](#implementation-and-test)
    - [Vulnerabilities Prevented](#vulnerabilities-prevented-1)
    - [References](#references-1)
- [C2: Leverage Security Frameworks and Libraries](#c2-leverage-security-frameworks-and-libraries)
    - [Description](#description-2)
    - [Implementation Best Practices](#implementation-best-practices)
    - [Vulnerabilities Prevented](#vulnerabilities-prevented-2)
    - [Tools](#tools-1)
- [C3: Secure Database Access](#c3-secure-database-access)
    - [Description](#description-3)
    - [Secure Queries](#secure-queries)
        - [Caution on Query Parameterization](#caution-on-query-parameterization)
    - [Secure Configuration](#secure-configuration)
    - [Secure Authentication](#secure-authentication)
    - [Secure Communication](#secure-communication)
    - [Vulnerabilities Prevented](#vulnerabilities-prevented-3)
    - [References](#references-2)
- [C4: Encode and Escape Data](#c4-encode-and-escape-data)
    - [Description](#description-4)
    - [Contextual Output Encoding](#contextual-output-encoding)
        - [Java Encoding Examples](#java-encoding-examples)
        - [.NET Encoding Examples](#net-encoding-examples)
        - [PHP Encoding Examples](#php-encoding-examples)
    - [Other Types of Encoding and Injection Defense](#other-types-of-encoding-and-injection-defense)
        - [Character Encoding and Canonicalization](#character-encoding-and-canonicalization)
    - [Vulnerabilities Prevented](#vulnerabilities-prevented-4)
    - [References](#references-3)
    - [Tools](#tools-2)
- [C5: Validate All Inputs](#c5-validate-all-inputs)
    - [Description](#description-5)
    - [Syntax and Semantic Validity](#syntax-and-semantic-validity)
    ...
    - [Regular Expressions](#regular-expressions)
        - [Caution: Potential for Denial of Service](#caution-potential-for-denial-of-service)
        - [Caution: Complexity](#caution-complexity)
    - [Limits of Input Validation](#limits-of-input-validation)
    - [Challenges of Validating Serialized Data](#challenges-of-validating-serialized-data)
    - [Unexpected User Input (Mass Assignment)](#unexpected-user-input-mass-assignment)
    - [Validating and Sanitizing HTML](#validating-and-sanitizing-html)
    - [Validation Functionality in Libraries and Frameworks](#validation-functionality-in-libraries-and-frameworks)
    - [Vulnerabilities Prevented](#vulnerabilities-prevented-5)
    - [References](#references-4)
    - [Tools](#tools-3)
- [C6: Implement Digital Identity](#c6-implement-digital-identity)
    - [Description](#description-6)
    - [Authentication Levels](#authentication-levels)
        - [Level 1 : Passwords](#level-1--passwords)
        - [Level 2 : Multi-Factor Authentication](#level-2--multi-factor-authentication)
        - [Level 3 : Cryptographic Based Authentication](#level-3--cryptographic-based-authentication)
    - [Session Management](#session-management)
        - [Session Generation and Expiration](#session-generation-and-expiration)
        - [Browser Cookies](#browser-cookies)
        - [Tokens](#tokens)
        - [JWT (JSON Web Tokens)](#jwt-json-web-tokens)
    - [Caution](#caution)
    - [Vulnerabilities Prevented](#vulnerabilities-prevented-6)
    - [References](#references-5)
    - [Tools](#tools-4)
- [C7: Enforce Access Controls](#c7-enforce-access-controls)
    - [Description](#description-7)
    - [Access Control Design Principles](#access-control-design-principles)
        - [1) Design Access Control Thoroughly Up Front](#1-design-access-control-thoroughly-up-front)
        - [2) Force All Requests to Go Through Access Control Checks](#2-force-all-requests-to-go-through-access-control-checks)
        - [3) Deny by Default](#3-deny-by-default)
        - [4) Principle of Least Privilege](#4-principle-of-least-privilege)
        - [5) Don't Hardcode Roles](#5-dont-hardcode-roles)
        - [6) Log All Access Control Events](#6-log-all-access-control-events)
    - [Vulnerabilities Prevented](#vulnerabilities-prevented-7)
    - [References](#references-6)
    - [Tools](#tools-5)
- [C8: Protect Data Everywhere](#c8-protect-data-everywhere)
    - [Description](#description-8)
    - [Data Classification](#data-classification)
    - [Encrypting Data in Transit](#encrypting-data-in-transit)
    - [Encrypting Data at Rest](#encrypting-data-at-rest)
        - [Mobile Application: Secure Local Storage](#mobile-application-secure-local-storage)
        - [Key Lifecycle](#key-lifecycle)
        - [Application Secrets Management](#application-secrets-management)
    - [Vulnerabilities Prevented](#vulnerabilities-prevented-8)
    - [References](#references-7)
    - [Tools](#tools-6)
- [C9: Implement Security Logging and Monitoring](#c9-implement-security-logging-and-monitoring)
    - [Description](#description-9)
    - [Benefits of Security Logging](#benefits-of-security-logging)
    - [Security Logging Implementation](#security-logging-implementation)
        - [Logging for Intrusion Detection and Response](#logging-for-intrusion-detection-and-response)
    - [Secure Logging Design](#secure-logging-design)
    - [References](#references-8)
    - [Tools](#tools-7)
- [C10: Handle all Errors and Exceptions](#c10-handle-all-errors-and-exceptions)
    - [Description](#description-10)
    - [Error Handling Mistakes](#error-handling-mistakes)
...
A good list of query parameterization examples in ASP, ColdFusion, C#, Delphi, .NET, Go, Java, Perl, PHP, PL/SQL, PostgreSQL, Python, R, Ruby and Scheme can be found at http://bobby-tables.com and the [OWASP Cheat Sheet on Query Parameterization](https://www.owasp.org/index.php/Query_Parameterization_Cheat_Sheet).
...
## References
* [XSS](https://www.owasp.org/index.php/XSS) - General information
